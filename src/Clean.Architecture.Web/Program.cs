  ...
  var mediatRAssemblies = new[]
{
  ...
  builder.Services.AddScoped<IListEmployeesQueryService, ListEmployeesQueryService>();
  builder.Services.AddScoped<IRequestHandler<ListEmployeesQuery, Result<IEnumerable<EmployeeDTO>>>, ListEmployeesHandler>();
}
